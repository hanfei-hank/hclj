...
instance Show o => Show (FunType o) where
  show (FunType as t) = "(" ++ show (map show as) ++ " -> " ++ show t ++ ")"
...
tyInteger,tyDecimal,tyTime,tyBool,tyString,tyList,tyObject,tyKeyword :: Text
tyInteger = "integer"
tyDecimal = "decimal"
tyTime = "time"
tyBool = "bool"
...
newtype TypeVarName = TypeVarName { _typeVarName :: Text }
  deriving (Eq,Ord,IsString,ToText,Hashable,Pretty,Generic,NFData)
